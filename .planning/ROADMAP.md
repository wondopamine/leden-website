...
- [~] **Phase 1: Design System Foundation + Brand Expression** — Tokens, component library, and a design-consultation–driven brand spec that all subsequent UI work consumes (plans 04/06 complete)
