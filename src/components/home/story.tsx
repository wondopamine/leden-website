...
export function Story({ place }: { place: PlaceData }) {
  ...
  return (
    <section id="about" className="scroll-mt-20 bg-card py-[var(--section-y-lg)]">
      <div className="mx-auto grid max-w-6xl items-end gap-10 px-5 md:grid-cols-12 md:gap-x-8 lg:gap-x-12">
        ...
        <FadeIn delay={120} className="md:col-span-4 md:col-start-9">
